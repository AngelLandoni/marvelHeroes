...
struct HeroesListModule {
    /// Instantiate the basic components.
    public let view: HeroesListView = HeroesListView()
    public let presenter: HeroesListPresenter = HeroesListPresenter()
